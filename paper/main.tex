...
\author{Jeff Kline}
\date{Version 0.1.0 --- release candidate}
...
A diversity assigns a size to each finite set of points; its $\ell_1$
model is the sum of coordinate ranges. Here the size of a terminal set is
